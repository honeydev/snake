...
(define(function() {
    ...
    return class MainPageDomSetter {
        ...
        setCountersSection(mainPageElements, previousDomObject) {
            ...
            $(mainPageElements.scoresStatment).
                appendTo(mainPageElements.scores);
            $(mainPageElements.timer).
                appendTo(mainPageElements.countersSection);
            $(mainPageElements.timerStatment).
                    appendTo(mainPageElements.timer);
            $(mainPageElements.temp).
                appendTo(mainPageElements.countersSection);
            $(mainPageElements.tempStatment).
                appendTo(mainPageElements.temp);
        };
    };
}));